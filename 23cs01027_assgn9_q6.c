...
void insert()
{
    if (num_studnts < maxStudents)
    {
        printf("Enter your name: ");
        gets(students[num_studnts].name);

        printf("Enter your roll number : ");
        scanf("%d", &students[num_studnts].roll_no);

        printf("Enter your percentage : ");
        scanf("%f", &students[num_studnts].pr);
        num_studnts++;
    }
    else
...
void delete(int num)
{
    ...
    if (index != -1)
    {
        for (int i = index; i < num_studnts; i++)
        {
            students[i] = students[i + 1];
        }
        num_studnts--;
